...
var InputSmart = function (_Component) {
	...
	function InputSmart() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = InputSmart.__proto__ || Object.getPrototypeOf(InputSmart)).call.apply(_ref, [this].concat(args))), _this), _this.storeInput = function (ref) {
	...
	_createClass(InputSmart, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(_inputFormat.ReactInput, _extends({}, rest, {
				ref: this.storeInput,
				parse: _parsePhoneNumberCharacters.parsePhoneNumberCharacter,
